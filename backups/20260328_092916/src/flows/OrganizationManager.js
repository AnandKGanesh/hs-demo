    ...
    <div className="space-y-6">
      <div>
        <div className="flex justify-between items-start mb-6">
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700 flex-1 mr-6 min-h-[160px]">
              ...
              {currentElement ? (
                ...
                <div className="h-full flex items-center justify-center">
                  <p className="text-sm text-slate-400 dark:text-slate-500 italic text-center">
                    Hover over any diagram element to see its definition and purpose within the organization structure.
                  </p>
                </div>
              )}
            </div>
          ...
          <button
            ...
            className="bg-primary hover:bg-primary-dark text-white font-medium px-6 py-3 rounded-lg flex items-center gap-2 whitespace-nowrap"
          >
            <Plus size={20} />
            Add New Merchant
          </button>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-0.5 h-6 bg-gray-300 mb-6"></div>

          <div className="grid grid-cols-[3fr_2fr] gap-6 w-full min-w-max">
