  ...
  useEffect(() => {
    ...
    if (flowId) {
      ...
      const allFlows = [
        ...
        { id: 'vault_3', name: 'HS SDK + External Vault Storage', description: 'Hyperswitch vault SDK with external storage' },
        { id: 'vault_5', name: 'External Vault SDK in HS SDK & External Storage', description: 'External vault in HS SDK with external storage' },
        { id: 'vault_4', name: 'External Vault SDK & Vault Storage with HS core', description: 'External vault SDK with Hyperswitch' },
        { id: 'vault_1', name: 'HS Vault SDK & Storage with PSP payload', description: 'Hyperswitch vault with PSP payload' },
        { id: 'vault_2', name: 'HS Vault SDK & Storage with HS payload', description: 'Hyperswitch vault with unified payload' },
      ];
  ...
  return (
    <Layout onFlowSelect={handleFlowSelect} currentFlow={currentFlow}>
      <div className="max-w-4xl mx-auto">
        ...
        {currentFlow && (
          <>
            <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 ${currentFlow.id === 'chargeback_unification' ? 'w-full' : 'max-w-2xl mx-auto'}`}>
