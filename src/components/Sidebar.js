...
import { CreditCard, Repeat, Shield, AlertTriangle, Database, ChevronRight, Lock, ChevronDown, ChevronUp, RefreshCw } from 'lucide-react';
...
const flowCategories = [
  ...
  },
  {
    ...
    icon: Lock,
    flows: [
      { id: 'vault_3', name: 'HS SDK + External Vault Storage', description: 'Hyperswitch vault SDK with external storage', disabled: false },
      { id: 'vault_5', name: 'External Vault SDK in HS SDK & External Storage', description: 'External vault in HS SDK with external storage', disabled: true },
      { id: 'vault_4', name: 'External Vault SDK & Vault Storage with HS core', description: 'External vault SDK with Hyperswitch', disabled: true },
      { id: 'vault_1', name: 'HS Vault SDK & Storage with PSP payload', description: 'Hyperswitch vault with PSP payload', disabled: true },
      { id: 'vault_2', name: 'HS Vault SDK & Storage with HS payload', description: 'Hyperswitch vault with unified payload', disabled: true },
    ],
  },
];
